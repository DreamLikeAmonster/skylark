...
if (pilih == "ke1") { 
conn.sendHydrated2(m.chat, text.trim(), wm, oh, 'https://youtu.be/nU1yFxB5hjI', 's ᴄ ʀ ɪ ᴘ ᴛ', 'https://instagram.com/finzofc', 'ɪ ɴ s ᴛ ᴀ ɢ ʀ ᴀ ᴍ', [['Menu', `.menuv1`],
  ['Owner', `.owner`],['Sewa', `.sewa`]], m)
}
if (pilih == "ke2") { 
conn.sendHydrated2(m.chat, text.trim(), botdate, urls, 'https://instagram.com/finzofc', 'ɪ ɴ s ᴛ ᴀ ɢ ʀ ᴀ ᴍ', 'https://youtube.com/@FinzOfc', 'ʏ ᴏ ᴜ ᴛ ᴜ ʙ ᴇ', [['Donasi', `.donasi`],
  ['Owner', `.owner`],['Sewa', `.sewa`]], m)
}
if (pilih == "ke3") { 
conn.sendHydrated2(m.chat, text.trim(), botdate, zykomd, 'https://www.tiktok.com/@finzofc', 'ᴛ ɪ ᴋ ᴛ ᴏ ᴋ', 'https://instagram.com/finzofc', 'ɪ ɴ s ᴛ ᴀ ɢ ʀ ᴀ ᴍ', [['Menu', `.menuv3`],
...
conn.send3ButtonVid(m.chat, `${sad}`, sapaa, text.trim() + `${nameown}\n` + botdate, 'Menu', '.menuv2', 'Owner', '.owner', 'Credit', '.credit', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https://instagram.com/finzofc',
    mediaType: 2, 
    description: sgc,
    title: `👋 ${sapa}, ${name}`,
    body: bottime,
